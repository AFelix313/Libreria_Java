...
public class UtileCodice {
	...
	// Che un metodo restituisca true o false è utile perchè così riesco a gestire se è andato a buon fine o no 
	// un metodo!!! Perciò molto più che utile di far tornare un Void
